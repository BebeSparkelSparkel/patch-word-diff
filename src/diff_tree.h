...
#define FILEDIFFHEADER_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define GITHEADER_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define PATCHHEADER_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define HUNKHEADER_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define DIFF_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define HUNK_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
...
#define PATCH_FIELDS(fieldType, fieldHeader, field, fieldPtr, fieldList, fieldUnion, infix, end) \
