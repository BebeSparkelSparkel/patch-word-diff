...
#define PARSE_STATE_TABLE(cons, map, ...) \
  ...
  cons(map(__VA_ARGS__, PS_EmptyPatch,         ), \
  cons(map(__VA_ARGS__, PS_WhiteSpace,         ), \
  cons(map(__VA_ARGS__, PS_DropWhiteSpace,     ), \
  cons(map(__VA_ARGS__, PS_WriteWhiteSpace,    ), \
  ...
  cons(map(__VA_ARGS__, PS_SourceEOF,          ), \
